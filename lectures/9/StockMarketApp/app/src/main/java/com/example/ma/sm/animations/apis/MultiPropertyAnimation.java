...
public class MultiPropertyAnimation extends Activity {
  ...
  public class MyAnimationView extends View
    ...
    public MyAnimationView(Context context) {
      super(context);
      balls.add(addBall(50, 0));
      balls.add(addBall(150, 10));
      balls.add(addBall(250, 0));
      balls.add(addBall(350, 10));
    }
    ...
    private void createAnimation() {
      if (bounceAnim == null) {
        ShapeHolder ball;
        ball = balls.get(0);
        ObjectAnimator yBouncer = ObjectAnimator.ofFloat(ball,
            "y",
            ball.getY(),
            getHeight() - BALL_SIZE).
        ...
        ObjectAnimator whxyBouncer = ObjectAnimator.
            ofPropertyValuesHolder(ball, pvhW, pvhH).
            setDuration(DURATION / 2);
        ...
        ObjectAnimator yxBouncer = ObjectAnimator.
            ofPropertyValuesHolder(ball, pvhY, pvhX).
            setDuration(DURATION / 2);
