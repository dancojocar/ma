 ...
 * <p>
 * <p>This class is used by the {@link CardFlipActivity}
 * and {@link ScreenSlideActivity} samples.</p>
 */
public class ScreenSlidePageFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup rootView = (ViewGroup) inflater
        .inflate(R.layout.fragment_screen_slide_page, container,
            false);

    // Set the title view to show the page number.
    TextView tv = rootView.findViewById(android.R.id.text1);
    tv.setText(getString(R.string.title_template_step, mPageNumber + 1));
