 ...
 * <p>
 * <p>In this sample, the user can touch one of two images.
 * Touching an image zooms it in, covering the entire activity
 * content area. Touching the zoomed-in image hides it.</p>
 */
public class ZoomActivity extends FragmentActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    animationDuration = getResources().
   ...
   * <p>
   * <ol>
   * <li>Assign the high-res image to the hidden "zoomed-in" (expanded)
   * image view.</li>
