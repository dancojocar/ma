 ...
 * <p>
 * <p>This sample shows an "info" action bar button that shows the back
 ...
 * system Back button or the "photo" action bar button.</p>
 */
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      case android.R.id.home:
        ...
        NavUtils.navigateUpTo(this, new Intent(this, AnimationsActivity.class));
        return true;
