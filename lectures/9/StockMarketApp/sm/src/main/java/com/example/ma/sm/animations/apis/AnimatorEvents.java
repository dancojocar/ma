  ...
  public class MyAnimationView extends View implements Animator.AnimatorListener,
    ...
    public void onAnimationStart(Animator animation) {
      if (animation instanceof AnimatorSet) {
        ...
        startText.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      } else {
        startTextAnimator.setAlpha(1f);
        startTextAnimator.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      }
      if (endImmediately) {
        animation.end();
      }
    ...
    public void onAnimationEnd(Animator animation) {
      if (animation instanceof AnimatorSet) {
        endText.setAlpha(1f);
        endText.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      } else {
        endTextAnimator.setAlpha(1f);
        endTextAnimator.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      }
    }
    ...
    public void onAnimationCancel(Animator animation) {
      if (animation instanceof AnimatorSet) {
        ...
        cancelText.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      } else {
        cancelTextAnimator.setAlpha(1f);
        cancelTextAnimator.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      }
    }
    ...
    public void onAnimationRepeat(Animator animation) {
      if (animation instanceof AnimatorSet) {
        ...
        repeatText.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      } else {
        repeatTextAnimator.setAlpha(1f);
        repeatTextAnimator.setTextColor(ContextCompat.getColor(getContext(), android.R.color.holo_red_dark));
      }
    }
  }
}