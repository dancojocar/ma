...
public class InMemoryNotesRepositoryTest {
  ...
  private final static List<Note> NOTES = Lists.newArrayList(new Note("Title1", "Description1"),
   ...
   */
  @Captor
  private ArgumentCaptor<NotesServiceApi.NotesServiceCallback<List<Note>>> mNotesServiceCallbackCaptor;
