...
const movies = [
  ...
  },
  {
    category: "Latest",
    imageUrl:
      "https://m.media-amazon.com/images/M/MV5BYmQzNmY3YzItOTE3OC00NGZjLTkwZDYtOWVmM2QyMzhiYTgwXkEyXkFqcGdeQXVyMTkxNjUyNQ@@._V1_SY278_CR2,0,184,278_.jpg",
  ...
  },
  {
    category: "Latest",
    imageUrl:
      "https://m.media-amazon.com/images/M/MV5BOTY2NzFjODctOWUzMC00MGZhLTlhNjMtM2Y2ODBiNGY1ZWRiXkEyXkFqcGdeQXVyMDM2NDM2MQ@@._V1_SY139_CR2,0,92,139_.jpg",
...
router.post("/movie", (ctx) => {
  ...
  if (!movie.link || typeof movie.link !== "string") {
    errors.link = "Link is required and must be a string.";
  }
  if (!movie.desc || typeof movie.desc !== "string") {
    errors.desc = "Description is required and must be a string.";
  }
