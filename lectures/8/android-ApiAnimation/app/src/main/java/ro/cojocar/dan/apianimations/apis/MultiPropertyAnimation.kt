...
class MultiPropertyAnimation : Activity() {
  ...
  inner class MyAnimationView(context: Context) : View(context),
    ...
    private var bounceAnim: Animator? = null
    ...
    private fun createAnimation() {
      if (bounceAnim == null) {
        ...
        val yAlphaBouncer =
          ObjectAnimator.ofPropertyValuesHolder(ball, pvhY, pvhAlpha)
        ...
        val whxyBouncer =
          ObjectAnimator.ofPropertyValuesHolder(ball, pvhW, pvhH)
            .setDuration((DURATION / 2).toLong())
        ...
        val yxBouncer =
          ObjectAnimator.ofPropertyValuesHolder(ball, pvhY, pvhX)
            .setDuration((DURATION / 2).toLong())
