...
import com.google.android.gms.location.sample.locationaddress.databinding.MainActivityBinding
...
class MainActivity : AppCompatActivity() {
  ...
  private fun getAddress() {
    ...
    })?.addOnFailureListener(this) { e -> logw("getLastLocation:onFailure", e) }
  }
  ...
  private fun showSnackbar(
    ...
    Snackbar.make(
      binding.root, getString(mainTextStringId),
  ...
  override fun onRequestPermissionsResult(
    ...
    when {
      grantResults.isEmpty() ->
        ...
        logi("User interaction was cancelled.")
