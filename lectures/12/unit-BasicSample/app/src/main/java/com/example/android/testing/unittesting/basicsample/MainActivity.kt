...
class MainActivity : Activity() {
  ...
  fun onSaveClick(@Suppress("UNUSED_PARAMETER") view: View) {
    ...
    if (!emailValidator.isValid) {
      ...
      logw("Not saving personal information: Invalid email")
      return
    }
    ...
    if (isSuccess) {
      ...
      logi("Personal information saved")
    } else {
      loge("Failed to write personal information to SharedPreferences")
    }
  }
  ...
  fun onRevertClick(@Suppress("UNUSED_PARAMETER") view: View) {
    ...
    logi("Personal information reverted")
  }
