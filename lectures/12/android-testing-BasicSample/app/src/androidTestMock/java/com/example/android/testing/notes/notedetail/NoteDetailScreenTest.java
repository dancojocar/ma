...
public class NoteDetailScreenTest {
  ...
  private static final String NOTE_TITLE = "ATSL";

  private static final String NOTE_DESCRIPTION = "Rocks";

  private static final String NOTE_IMAGE = "file:///android_asset/atsl-logo.png";

  /**
   * {@link Note} stub that is added to the fake service API layer.
   */
  private static final Note NOTE = new Note(NOTE_TITLE, NOTE_DESCRIPTION, NOTE_IMAGE);
