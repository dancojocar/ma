...
class ActivityFenceApiDemo : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onReceive(context: Context, intent: Intent) {
      ...
      if (TextUtils.equals(fenceState.fenceKey, ACTIVITY_STILL_FENCE_KEY)) {
        when (fenceState.currentState) {
          ...
          FenceState.FALSE -> mActivityFenceStatusTv!!.text =
              getString(R.string.movingMessage)
          FenceState.UNKNOWN -> mActivityFenceStatusTv!!.text =
              getString(R.string.unknownMessage)
        }
      } else if (TextUtils.equals(fenceState.fenceKey, ACTIVITY_MOVING_FENCE_KEY)) {
        when (fenceState.currentState) {
          FenceState.FALSE -> mActivityFenceStatusTv!!.text =
              getString(R.string.stillMessage)
