...
import com.google.android.gms.location.sample.activityrecognition.BuildConfig.APPLICATION_ID
...
class MainActivity : AppCompatActivity(), OnSharedPreferenceChangeListener {
  ...
  public override fun onCreate(savedInstanceState: Bundle?) {
    ...
    mContext = this
    // Get the UI widgets.
    mRequestActivityUpdatesButton = findViewById<View>(R.id.request_activity_updates_button) as Button
    mRemoveActivityUpdatesButton = findViewById<View>(R.id.remove_activity_updates_button) as Button
    val detectedActivitiesListView = findViewById<View>(
        R.id.detected_activities_listview) as ListView
...
// whether activity updates have been requested.
  ...
  private fun startLocationPermissionRequest() {
    ActivityCompat.requestPermissions(this, arrayOf(ACTIVITY_RECOGNITION),
