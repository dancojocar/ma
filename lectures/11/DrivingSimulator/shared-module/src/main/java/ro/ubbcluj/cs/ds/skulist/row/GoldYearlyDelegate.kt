 ...
 */
class GoldYearlyDelegate internal constructor(billingProvider: BillingProvider) : UiManagingDelegate(billingProvider) {
  ...
  override fun onBindViewHolder(data: SkuRowData, holder: RowViewHolder) {
    ...
    if (mBillingProvider.isGoldYearlySubscribed) {
      ...
      val textId = if (mBillingProvider.isGoldMonthlySubscribed)
