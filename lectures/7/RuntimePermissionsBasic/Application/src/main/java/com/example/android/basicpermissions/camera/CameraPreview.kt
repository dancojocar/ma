...
import com.example.android.basicpermissions.util.logd
import com.example.android.basicpermissions.util.loge
...
class CameraPreview @JvmOverloads constructor(
  ...
  override fun surfaceCreated(holder: SurfaceHolder) {
    ...
    try {
      ...
      loge("Error setting camera preview: ${e.message}", e)
    }
  ...
  override fun surfaceChanged(holder: SurfaceHolder, format: Int, w: Int, h: Int) {
    ...
    if (holder.surface == null) {
      ...
      logd("Preview surface does not exist")
      return
    }
