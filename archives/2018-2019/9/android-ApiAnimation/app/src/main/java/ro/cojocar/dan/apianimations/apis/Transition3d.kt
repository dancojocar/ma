...
class Transition3d : Activity(), AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mPhotosList = findViewById<View>(android.R.id.list) as ListView
        mImageView = findViewById<View>(R.id.picture) as ImageView
        mContainer = findViewById<View>(R.id.container) as ViewGroup
     ...
     */
    private inner class DisplayNextView constructor(val mPosition: Int) : Animation.AnimationListener {
    ...
    companion object {
        ...
        private val PHOTOS_NAMES = arrayOf("Lyon", "Livermore", "Tahoe Pier", "Lake Tahoe", "Grand Canyon", "Bodie")
