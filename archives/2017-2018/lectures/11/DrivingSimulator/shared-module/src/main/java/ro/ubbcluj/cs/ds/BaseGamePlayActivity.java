...
import static ro.ubbcluj.cs.ds.billing.BillingManager.BILLING_MANAGER_NOT_INITIALIZED;
 ...
 */
public abstract class BaseGamePlayActivity
    extends FragmentActivity implements BillingProvider {
