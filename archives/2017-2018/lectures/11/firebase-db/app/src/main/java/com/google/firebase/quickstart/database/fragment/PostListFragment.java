...
public abstract class PostListFragment extends Fragment {
  ...
  public void onActivityCreated(Bundle savedInstanceState) {
    ...
    mAdapter = createAdapater(postsQuery);
    mRecycler.setAdapter(mAdapter);
  }

  @NonNull
  private FirebaseRecyclerAdapter<Post, PostViewHolder>
  createAdapater(final Query postsQuery) {
    return new FirebaseRecyclerAdapter<Post,
        PostViewHolder>(Post.class, R.layout.item_post,
      ...
      protected void populateViewHolder(final PostViewHolder viewHolder,
        ...
        // and set UI accordingly
        if (model.stars.containsKey(getUid())) {
          viewHolder.starView.
              setImageResource(R.drawable.ic_toggle_star_24);
        } else {
          viewHolder.starView.
              setImageResource(R.drawable.ic_toggle_star_outline_24);
        }
        ...
        viewHolder.bindToPost(model, new View.OnClickListener() {
          ...
          public void onClick(View starView) {
            ...
            DatabaseReference globalPostRef = mDatabase.child("posts").
