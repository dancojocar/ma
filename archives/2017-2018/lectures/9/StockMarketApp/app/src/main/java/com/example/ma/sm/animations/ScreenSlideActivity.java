 ...
 * Because {@link ViewPager} automatically plays such an animation
 * when calling {@link ViewPager#setCurrentItem(int)}, there
 ...
 * played when the user presses the "previous" button.</p>
 *
...
public class ScreenSlideActivity extends BaseActivity {
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.findItem(R.id.action_previous).
        setEnabled(mPager.getCurrentItem() > 0);
