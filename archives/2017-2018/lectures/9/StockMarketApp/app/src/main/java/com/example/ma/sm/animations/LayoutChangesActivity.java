...
package com.example.ma.sm.animations;
 ...
 * a {@link ViewGroup}.
 * <p>
 * <p>In this sample, the user can add rows to and remove rows
 * from a vertical {@link android.widget.LinearLayout}.</p>
 */
public class LayoutChangesActivity extends BaseActivity {
  ...
  private static final String[] COUNTRIES = new String[]{
      ...
      "Austria", "Romania", "Russia", "Poland", "Croatia",
      "Greece", "Ukraine",
  };
  /**
   * The container view which has layout change animations turned on.
   * In this sample, this view is a {@link android.widget.LinearLayout}.
   */
    ...
    switch (item.getItemId()) {
      case android.R.id.home:
        ...
        NavUtils.navigateUpTo(this,
            new Intent(this, AnimationsActivity.class));
        return true;
  ...
  private void addItem() {
    ...
    final ViewGroup newView = (ViewGroup) LayoutInflater.
        from(this).inflate(R.layout.list_item_example,
        mContainerView, false);

    // Set the text in the new row to a random country.
    TextView tv = newView.findViewById(android.R.id.text1);
    tv.setText(COUNTRIES[(int) (Math.random() * COUNTRIES.length)]);

    // Set a click listener for the "X" button in the row
    // that will remove the row.
    View deleteButton = newView.findViewById(R.id.delete_button);
