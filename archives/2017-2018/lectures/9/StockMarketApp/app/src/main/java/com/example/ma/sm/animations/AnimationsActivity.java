...
public class AnimationsActivity extends ListActivity {
   ...
   * This gets instantiated in {@link
   * #onCreate(android.os.Bundle)} because the {@link Sample}
   * constructor needs access to {@link android.content.res.Resources}.
   */
  ...
  protected void onListItemClick(ListView listView, View view,
    ...
    startActivity(new Intent(AnimationsActivity.this,
